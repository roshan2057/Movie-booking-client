...
const Profile = () => {
  return (
   <>
<div class="flex bg-clip-border rounded-xl bg-white text-gray-700 h-96  px-4 shadow-xl shadow-blue-gray-900/5">

   
<nav class="flex flex-col gap-1 min-w-[310px] p-2 font-sans text-base font-normal text-gray-700 border-r-2">
    <Link to='/profile/details' role="button" tabindex="0" class="flex items-center w-full p-3 rounded-lg text-start leading-tight transition-all hover:bg-blue-50 hover:bg-opacity-80 focus:bg-blue-50 focus:bg-opacity-80 active:bg-gray-50 active:bg-opacity-80 hover:text-blue-900 focus:text-blue-900 active:text-blue-900 outline-none">
